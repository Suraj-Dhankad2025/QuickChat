...
import (
	...
	"Suraj-Dhankad2025/chat-server/rabbit"
	"Suraj-Dhankad2025/chat-server/routes"
	"Suraj-Dhankad2025/chat-server/utils"
	ws "Suraj-Dhankad2025/chat-server/websocket"
...
func main() {
	...
	c := cors.New(cors.Options{AllowedOrigins: []string{"http://localhost:3000","http://localhost:5173", "https://QuickChat.vercel.app"}, AllowCredentials: true, AllowedHeaders: []string{"Content-Type", "Bearer", "Bearer ", "content-type", "Origin", "Accept"}})
